...
const NAV: { href: string; label: string; rollen: Rolle[] }[] = [
  ...
  { href: '/export', label: 'Export-Center', rollen: ['AGM', 'VERTRIEBSLEITER', 'BU_LEITER', 'ADMIN', 'SUPPORT'] },
  { href: '/import', label: 'Import', rollen: ['BU_LEITER', 'ADMIN'] },
  { href: '/admin/quarantaene', label: 'Import-Quarantäne', rollen: ['BU_LEITER', 'ADMIN', 'SUPPORT'] },
