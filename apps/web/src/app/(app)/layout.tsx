...
const NAV: { href: string; label: string; rollen: Rolle[] }[] = [
  ...
  { href: '/absatz', label: 'Absatz / Stückzahlen', rollen: ['VERTRIEBSLEITER', 'BU_LEITER', 'ADMIN', 'SUPPORT'] },
  ...
  return (
    <div className="min-h-screen">
      ...
      {user.passwortWechselPflicht && (
        <div className="bg-ez-accent/10 px-4 py-2 text-center text-sm text-ez-accent">
          Hinweis: Bitte ändern Sie Ihr Initialpasswort.
        </div>
      )}
